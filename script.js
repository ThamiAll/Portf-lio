/* =========================================================
   1. DICIONÁRIO DE IDIOMAS (i18n: PT / EN - Sem colchetes)
   ========================================================= */
const translations = {
  pt: {
...
const footWord = document.getElementById('footWord');
if(footWord) footWord.addEventListener('click', () => document.getElementById('contact').scrollIntoView({ behavior: 'smooth' }));
