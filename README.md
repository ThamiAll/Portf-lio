...
O projeto apresenta cases reais e conceituais de produtos digitais, métricas de backlog, sprints no Jira com capacidade técnica e arquitetura de sistemas.
...
- **Design & Prototipagem:** Figma, UI/UX Systems & Micro-interações
...
- **Micro-interações:** Efeitos de cursor magnético, hover states customizados e transições suaves de scroll.
- **Dark Mode Nativo:** Interface imersiva baseada em escala de cinzas profundos (`#0a0a0a`) com acentos em degradê.
...
├── estilo.css         # Estilização modular, temas e animações
